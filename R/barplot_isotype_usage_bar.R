...
#' @examples
#' plot_isotype_usage_bar(list_repertoires=example_data, path_figures="")

plot_isotype_usage_bar<-function (list_repertoires, order_ids,chain = "H", sample_name, text_size = 5, width_height = c(x = 10, y = 10), path_figures = "",color_scale_category=c('#66c2a5','#fc8d62','#8da0cb','#e78ac3','#a6d854','#ffd92f')){
  ...
  grDevices::pdf(file.path(path_figures, paste("Isotype_usage_category_",sample_name,"_bar.pdf",sep="")),  width = 5,  height = 5)
